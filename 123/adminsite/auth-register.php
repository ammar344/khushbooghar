...
if(isset($_REQUEST['sign_up'])){
  ...
  // user check
  $checkUser = "SELECT * FROM admin_users WHERE user_name='$userName' OR user_email='$userEmail'";
  $checkUserQuery = mysqli_query($conn, $checkUser);
  if(mysqli_num_rows($checkUserQuery) > 0){
    echo "username or email is already existed";
  }else{
    $hashedPassword = password_hash($userPassword, PASSWORD_DEFAULT);
    $insertUser = "INSERT INTO admin_users (name, user_name, user_email, user_pass) VALUES (?, ?, ?, ?)";
...
>
  <head>
    ...
    <title>Register | Khushboo Ghar</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                ...
                <h4 class="mb-2 logo">Khusboo Ghar</h4>
              </span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Register Yourself to Khusboo Ghar</h4>
