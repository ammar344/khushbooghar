...
if (isset($_REQUEST['signIn'])) {
  ...
  $login = "SELECT * FROM admin_users WHERE user_email=? OR user_name=?";
  ...
  if ($result->num_rows > 0) {
      ...
      // Verify the password
      if (password_verify($userPassword, $user['user_pass'])) {
          // Password is correct
...
>
  <head>
    ...
    <title>Login Admin | Khusboo Ghar</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <img src="./assets/img/coffeeadda.png" alt="">
              </span>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Khusboo Ghar Admin! 👋</h4>
